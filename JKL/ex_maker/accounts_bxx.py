...
for i in range(988, 1026):
    account_info['TTEX']['BTC']['MANA'].append(['TTEX', str(12012340001 + i), '1234Rty77899x'])

for i in range(1026, 1064):
    account_info['TTEX']['BTC']['PAY'].append(['TTEX', str(12012340001 + i), '1234Rty77899x'])

for i in range(1064, 1102):
    account_info['TTEX']['BTC']['POWR'].append(['TTEX', str(12012340001 + i), '1234Rty77899x'])

for i in range(1102, 1140):
    account_info['TTEX']['BTC']['GVT'].append(['TTEX', str(12012340001 + i), '1234Rty77899x'])
...
for i in range(1178, 1216):
    account_info['COINX']['USDT']['GNT'].append(['COINX', str(12012340001 + i), '1234Rty77899x'])

for i in range(1216, 1254):
    account_info['COINX']['USDT']['BTM'].append(['COINX', str(12012340001 + i), '1234Rty77899x'])

for i in range(1254, 1292):
    account_info['COINX']['USDT']['SNT'].append(['COINX', str(12012340001 + i), '1234Rty77899x'])

for i in range(1292, 1330):
    account_info['COINX']['USDT']['IOST'].append(['COINX', str(12012340001 + i), '1234Rty77899x'])
