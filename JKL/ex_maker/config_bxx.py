...
def get_config(ex_name, symbol):
    ...
    if symbol == ['BTC', 'USDT']:
        ...
        msym = 'BTC'
        order_gap = 0.02
    elif symbol == ['MANA', 'BTC']:
        sym0 = 'MANA'
        sym_base0 = 'BTC'
        exchange_base = 'huobi'
        base_order_quantity_scale = 120000
        base_order_range_scale = 1
        avg_sym_btc = 1 / 90000
        symbol_price_decimal = 8
        symbol_quant_decimal = 4
        ...
        order_gap = 0.03
        auto_price = BaseWavingPrice(ex_name, symbol[0], symbol[1], symbol_price_decimal,
                                     0.00006, 0.02, 0.001, 0.004, 0.001)
    elif symbol == ['HB', 'BTC']:
        sym0 = 'HB'
        sym_base0 = 'USDT'
        exchange_base = 'bxx'
        ...
        msym = 'BTC'
        order_gap = 0.001
        auto_price = FakeStatusPrice(ex_name, symbol[0], symbol[1], symbol_price_decimal, 3.80, 10, 10000, 0.0005)
    elif symbol == ['DUH', 'BTC']:
        sym0 = 'DUH'
        sym_base0 = 'BTC'
        exchange_base = 'fixed'
        ...
        msym = 'BTC'
        order_gap = 0.001
        auto_price = FakeStatusPrice(ex_name, symbol[0], symbol[1], symbol_price_decimal, 0.00041, 0.25, 250, 0.0006)
        ...
        msym = 'BTC'
        order_gap = 0.001
        auto_price = FakeStatusPrice(ex_name, symbol[0], symbol[1], symbol_price_decimal, 0.0005, 0.2, 200, 0.0006)
        ...
        msym = 'BTC'
        order_gap = 0.001
        auto_price = FakeStatusPrice(ex_name, symbol[0], symbol[1], symbol_price_decimal, 0.00067, 0.2, 200, 0.0005)
        ...
        msym = 'BTC'
        order_gap = 0.001
        auto_price = FakeStatusPrice(ex_name, symbol[0], symbol[1], symbol_price_decimal, 0.000141, 0.7, 700, 0.0005)
        ...
        msym = 'BTC'
        order_gap = 0.001
        auto_price = FakeStatusPrice(ex_name, symbol[0], symbol[1], symbol_price_decimal, 0.000223, 0.5, 500, 0.0004)
        ...
        msym = 'BTC'
        order_gap = 0.001
        auto_price = FakeStatusPrice(ex_name, symbol[0], symbol[1], symbol_price_decimal, 0.0000595, 2, 2000, 0.0004)
    elif symbol == ['ZVX', 'BTC']:
        sym0 = 'ZVX'
        sym_base0 = 'BTC'
        exchange_base = 'fixed'
        ...
        msym = 'BTC'
        order_gap = 0.001
        auto_price = FakeStatusPrice(ex_name, symbol[0], symbol[1], symbol_price_decimal, 0.00008, 1, 1500, 0.0006)
        ...
        msym = 'BTC'
        order_gap = 0.001
        auto_price = FakeStatusPrice(ex_name, symbol[0], symbol[1], symbol_price_decimal, 0.000203, 0.5, 500, 0.0006)
    elif symbol == ['JLO', 'BTC']:
        sym0 = 'JLO'
        sym_base0 = 'BTC'
        exchange_base = 'fixed'
        ...
        msym = 'BTC'
        order_gap = 0.001
        auto_price = FakeStatusPrice(ex_name, symbol[0], symbol[1], symbol_price_decimal, 0.000019, 6, 6000, 0.0005)
        ...
        msym = 'BTC'
        order_gap = 0.001
        auto_price = FakeStatusPrice(ex_name, symbol[0], symbol[1], symbol_price_decimal, 0.000435, 0.25, 250, 0.0005)
        ...
        msym = 'BTC'
        order_gap = 0.001
        auto_price = FakeStatusPrice(ex_name, symbol[0], symbol[1], symbol_price_decimal, 98.5808, 2000, 200000, 0.0012)
        ...
        msym = 'BTC'
        order_gap = 0.001
        auto_price = FakeStatusPrice(ex_name, symbol[0], symbol[1], symbol_price_decimal, 72.8217, 10, 8000, 0.0005)
        ...
        msym = 'BTC'
        order_gap = 0.01
        auto_price = BaseWavingPrice(ex_name, symbol[0], symbol[1], symbol_price_decimal, 0.09, 0.15, 0.09, 0.12,
                                     0.001)
        ...
        msym = 'BTC'
        order_gap = 0.02
    elif symbol == ['SNT', 'USDT']:
        sym0 = 'SNT'
        sym_base0 = 'USDT'
        exchange_base = 'huobi'
        base_order_quantity_scale = 130000
        base_order_range_scale = 1
        ...
        msym = 'LTC'
        order_gap = 0.02
        auto_price = BaseWavingPrice(ex_name, symbol[0], symbol[1], symbol_price_decimal, 0.020, 0.08, 0.01, 0.04,
