...
class kline():
    ...
    # 'XBTUSD'
    def get_kline(self, binSize='1m', startTime='2018-1-28'):
    ...
    def get_starttime(self, ret):
        ...
        if int(time_list[1]) < 9:
            startTime = time_list[0] + ':0' + str(int(time_list[1]) + 1) + ':' + time_list[2]
        elif 9 < int(time_list[1]) < 59:
            startTime = time_list[0] + ':' + str(int(time_list[1]) + 1) + ':' + time_list[2]
...
# ['XBTUSD', '永续.csv'], ['XBTZ18', '12月期货.csv'],
a = [['XBTU18', '9月期货.csv'], ['XBTM18', '6月期货.csv'], ['XBTH18', '3月期货.csv']]
for i in a:
